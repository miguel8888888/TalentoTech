<x-app-layout>
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        ...
        <div class="flex mb-6" style="justify-content: space-between; align-items: center;">
            <form class="w-1/2" action="{{ route('usuarios.search') }}" method="GET">   
                    ...
                    @foreach ($users as $data)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="flex items-center px-6 py-4">
                                <a href="{{ route('profileuser.edit', $data->id) }}"
                                    :isActive="request()->routeIs('profileuser.edit', $data->id)" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Editar</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
